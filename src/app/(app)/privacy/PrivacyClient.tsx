  ...
  return (
    <div className="space-y-8">
      ...
      {studentId ? (
        ...
        <div className="rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6">
          <h2 className="text-lg font-semibold text-[var(--text-primary)]">Your data rights</h2>
          <p className="mt-1 text-sm text-[var(--text-secondary)]">
            You own your data. Once you sign in, you can download a complete copy of everything
            or request that we delete your account entirely.
          </p>
          <a
            href="/login"
            className="mt-4 inline-block rounded-lg bg-[var(--primary)] px-5 py-2.5 text-sm font-semibold text-white hover:bg-[var(--primary-light)] transition-colors"
          >
